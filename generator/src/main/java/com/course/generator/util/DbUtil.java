...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/course?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&useAffectedRows=true";
            String user = "root";
            String pass = "tiger";
